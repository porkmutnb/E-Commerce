...
<div class="container mh-100 bg-white bg-shadow pb-md-5">
	...
	<div class="row text-dark">
		...
		<div class="col-md-4 col-sm-4 col-4 pr-md-2 pr-1 pl-md-3 pl-2 mb-2 mb-md-3">
			<div class="col block-product pl-0 pr-0 pointer" data-toggle="modal" data-target="#modalProduct">
				...
				<div class="label-priceproduct font-lg-22 font-md-18 font-sm-14 font-12 b-2 r-2">
					199 <div class="inline font-lg-18 font-md-14 font-sm-12 font-10">บาท.</div>
				</div>
				<img src="public/image/pd-1.jpeg" class="w-100 h-100 fit-cover">
			</div>
		</div>
		...
		<div class="col-md-4 col-sm-4 col-4 pr-md-3 pr-2 pl-1 pl-md-2 mb-2 mb-md-3">
			<div class="col block-product pl-0 pr-0 pointer" data-toggle="modal" data-target="#modalProduct">
                <div class="label-nameproduct w-100 font-lg-26 font-md-22 font-12 pt-md-2 pt-lg-2 pt-2 font-sm-16 pl-md-4 pl-2">
                    เสื้อแขนยาวผู้หญิง
                </div>
