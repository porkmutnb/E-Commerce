<?php
    ...
    $sqlorderinfo = "SELECT tbl_order.orderID, tbl_user.email, tbl_order.address, tbl_order.evidence, tbl_order.status, tbl_order.created_at, tbl_user.telephone FROM `tbl_order` JOIN tbl_user ON tbl_order.userID = tbl_user.userID ORDER BY tbl_order.created_at DESC";
    ...
    $sqlcategory = "SELECT categoryID, categoryName FROM tbl_category";
