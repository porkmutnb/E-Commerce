...
<div class="container mh-100 bg-white bg-shadow pb-md-5">
	<div class="row">
		<div class="col plr-md-0">
			<div class="block-slide-image">
				<img src="public/image/showImage.jpg" class="w-100 h-100 fit-cover">
			</div>
		</div>
	</div>
	<div class="row" align="center">
		<div class="col-md-12 col-sm-12 col-12 pt-md-15 font-lg-22 font-sm-18">
	...
	<div class="row font-white bg-black">
		...
		<div class="col-md-6 col-sm-6 col-6 pr-md-2 pr-1 pl-md-3 pl-2 mb-2 mb-md-3">
			<div class="col block-product pl-0 pr-0 pointer" data-toggle="modal" data-target="#modalProduct">
				...
				<img src="public/image/testFood.jpeg" class="w-100 h-100 fit-cover">
			</div>
		</div>
		...
		<div class="col-md-4 col-sm-4 col-4 pr-md-2 pr-1 pl-2 pl-md-3 mb-2 mb-md-3">
			<div class="col block-product-spacial pl-0 pr-0 pointer" data-toggle="modal" data-target="#modalProduct">
		...
		<div class="col-md-6 col-sm-6 col-6 pr-md-2 pr-1 pl-2 pl-md-3 mb-2 mb-md-3">
			<div class="col block-product pl-0 pr-0 pointer" data-toggle="modal" data-target="#modalProduct">
				<div class="label-nameproduct w-100 font-lg-26 font-md-22 font-12 pt-md-2 pt-lg-2 pt-2 font-sm-16 pl-md-4 pl-2">
					ผัดรวมมิตร
				</div>
		...
		<div class="col-md-6 col-sm-6 col-6 pl-md-2 pl-1 pr-2 pr-md-3 mb-2 mb-md-3">
			<div class="col block-product pl-0 pr-0 pointer" data-toggle="modal" data-target="#modalProduct">
				<div class="label-nameproduct w-100 font-lg-26 font-md-22 font-12 pt-md-2 pt-lg-2 pt-2 font-sm-16 pl-md-4 pl-2">
					ผัดรวมมิตร
				</div>
	...
	<div class="row">
		<div class="col pt-md-5 mb-lg-5 mb-sm-5 mb-5 pt-3 pb-md-1 pb-4 pl-5 pr-5" align="center">
			<a href="requirelocation.php" class="btn btn-danger w-100" style="">จัดส่ง</a>
		</div>
	</div>
