	        	...
	        	<div class="modal-header relative border-none pt-md-5 pt-4 pb-md-4 pl-md-4 pr-md-4">
	        		<div class="row">
	        			<div class="col-md-6 col-sm-6 col-12 pr-md-0 pt-sm-0 pt-4">
	        				<img src="public/image/pd-1.jpeg" class="w-100">
	        				<div class="col-md-6 col-sm-6 col-12 d-sm-none pl-sm-0 pl-3 pr-0 pt-sm-0 pt-2">
	        					<b class="font-weight-bold font-lg-20 font-sm-18">เสื้อแขนยาว</b>
	        						...
	        						<div class="block-add-number">
	        							<div class="row ml-md-0 mr-md-0 ml-0" align="center">
	        								<div class="col-md-4 col-4 plr-md-0">
	        									<button class="btn-circle rounded-circle">
	        										<i class="fas fa-plus"></i>
	        									</button>
	        								</div>
	        								<div class="col-md-4 col-4 pt-md-1 pt-1 pl-md-0 pr-md-0 font-lg-18">
	        									1
	        								</div>
	        								<div class="col-md-4 col-4 plr-md-0">
	        									<button class="btn-circle rounded-circle">
	        			...
	        			<div class="col-md-6 col-sm-6 col-12 d-none d-sm-block pl-sm-0 pl-md-3 pl-3 pt-sm-0 pt-4">
	        				<b class="font-weight-bold font-lg-20 font-sm-20">เสื้อแขนยาว</b>
	        				<ul class="pt-md-2 pl-4 font-sm-16">
	        					<li>เสื้อแขนยาว</li>
	        					<li>ใส่สบาย</li>
	        				</ul>
	        			...
	        			<div class="col-md-12 mt-md-3 mt-3">
	        				<a class="btn btn-orange w-100" data-dismiss="modal" aria-label="Close">สั่งซื้อ</a>
	        			</div>
	        		</div>
